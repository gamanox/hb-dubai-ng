...
export class RunComponent implements OnInit {
  ...
  runs = [
    {
      ...
      title: "DUBAI CANAL",
      description: " DM @highbeamsdubai for invite details",
      type: "run",
  ...
  nextMarker(): void {
    if (this.myIndex < this.runs.length) {
      ...
      var mkrnewPossition = new google.maps.LatLng(
  ...
  initMap(): void {
    ...
    const currentPossition = new google.maps.LatLng(
      parseFloat(possLongitude),
      parseFloat(possLatitude)
    );
